...
template<>
TagLib::IT::Properties* Userdata<TagLib::IT::Properties, LuaTagLib::AudioProperties>::pushValue(lua_State* L, const TagLib::IT::Properties& val) {
    luaL_error(L, "unable to push IT::Properties by value");
    return NULL;
}
