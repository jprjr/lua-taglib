...
template<>
TagLib::S3M::Properties* LuaTagLib::Userdata<TagLib::S3M::Properties, LuaTagLib::DerivedUserdata<TagLib::S3M::Properties, LuaTagLib::AudioProperties> >::pushValue(lua_State* L, const TagLib::S3M::Properties& val) {
